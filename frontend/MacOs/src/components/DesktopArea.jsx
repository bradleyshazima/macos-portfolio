...
const DesktopArea = () => {
  ...
  return (
    <section className='w-full h-[calc(100vh-24px)] minmax-w-100'>
      <div className='h-full w-[276px] px-8 pt-4 pb-24 flex flex-col flex-wrap items-start justify-start gap-3 text-white'>
        {desktopIcons.map((icon, index) => (
          <div key={index} className='w-[100px] h-[100px] p-1 hover:bg-[#ffffff33] rounded flex flex-col items-center justify-between'>
